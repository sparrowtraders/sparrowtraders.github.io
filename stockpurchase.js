(function () {
    ...
    function initEmbed() {
      ...
      var handler = StripeCheckout.configure({
        ...
        image: 'https://res.cloudinary.com/arcjet-media/image/upload/c_scale,w_256/v1588996083/clwgdpatnn8itkxdljjc.jpg',
        locale: 'auto',
      ...
      var btns = document.querySelectorAll('.lp5687952353263616');
      var bgColor = jQuery('.lp5687952353263616').css('background-color')
      ...
      for (var i = 0; i < btns.length; i++) {
        btns[i].addEventListener("click", function (e) {
          handler.open({
            name: "sparrow",
            email: urlEmail,
            description: validCoupon ? couponDesc : "$10 / monthly",
      ...
      jQuery('.couponLink').click(function (evt) {
        jQuery(evt.target).replaceWith(
          `<form style=`+ formStyle +`  class="couponForm lp5687952353263616">
            <input
              style=` + inputStyle + `
              type="text" 
        ...
        jQuery('.couponForm.lp5687952353263616').submit(function (e) {
          e.preventDefault()
