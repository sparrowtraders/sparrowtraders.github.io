(function () {
    ...
    function initEmbed() {
      ...
      var handler = StripeCheckout.configure({
        ...
        image: 'https://res.cloudinary.com/arcjet-media/image/upload/c_scale,w_256/v1588996123/lllvslci6dtyyuojge5b.jpg',
        locale: 'auto',
      ...
      var btns = document.querySelectorAll('.lp5967486742953984');
      var bgColor = jQuery('.lp5967486742953984').css('background-color')
      ...
      for (var i = 0; i < btns.length; i++) {
        btns[i].addEventListener("click", function (e) {
          handler.open({
            name: "sparrow",
            email: urlEmail,
            description: validCoupon ? couponDesc : "$15 / monthly",
      ...
      jQuery('.couponLink').click(function (evt) {
        jQuery(evt.target).replaceWith(
          `<form style=`+ formStyle +`  class="couponForm lp5967486742953984">
            <input
              style=` + inputStyle + `
              type="text" 
        ...
        jQuery('.couponForm.lp5967486742953984').submit(function (e) {
          e.preventDefault()
