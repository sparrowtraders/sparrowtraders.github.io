(function () {
    ...
    function initEmbed() {
      ...
      var handler = StripeCheckout.configure({
        ...
        image: 'https://res.cloudinary.com/arcjet-media/image/upload/c_scale,w_256/v1588996206/bfk2jfvjigqd5oqvch1f.jpg',
        locale: 'auto',
      ...
      var btns = document.querySelectorAll('.lp5143575918804992');
      var bgColor = jQuery('.lp5143575918804992').css('background-color')
      ...
      jQuery('.couponLink').click(function (evt) {
        jQuery(evt.target).replaceWith(
          `<form style=`+ formStyle +`  class="couponForm lp5143575918804992">
            <input
              style=` + inputStyle + `
              type="text" 
        ...
        jQuery('.couponForm.lp5143575918804992').submit(function (e) {
          e.preventDefault()
